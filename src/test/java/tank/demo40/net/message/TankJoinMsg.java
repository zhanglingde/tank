...
public class TankJoinMsg extends Msg{
    ...
    public void handle() {
        ...
        if (id.equals(GameModel.getInstance().getMyTank().getId())
                || (GameModel.getInstance().getByUUId(id) != null && GameModel.getInstance().getByUUId(id) instanceof Tank)) {
            return;
        }
        ...
        Client.INSTANCE.send(new TankJoinMsg(GameModel.getInstance().getMyTank()));
    }
